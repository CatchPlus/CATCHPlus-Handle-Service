 ...
 * 
 * $Id: portal_mysql.php 2459 2009-08-10 21:20:41Z pieterb $
 **************************************************************************/
...
/**
 * A MySQL exception.
 * This exception is thrown by some MySQL related methods in {@link Portal
 * class Portal }.
 * @package Portal
 */
class Portal_MySQL_Exception extends Exception {}
 ...
 * @package Portal
 */
class Portal_Retry_Exception extends Portal_MySQL_Exception {}
  ...
  public static function real_query($query) {
    if (! self::mysql()->real_query($query)) {
      if (self::mysql()->errno == 1205 || self::mysql()->errno == 1213)
        throw new Portal_Retry_Exception( self::mysql()->error );
      throw new Portal_MySQL_Exception( self::mysql()->error, self::mysql()->errno );
    }
  }
